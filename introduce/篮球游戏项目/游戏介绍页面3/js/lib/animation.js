 ...
 */
function animationSlow ( obj, attrs, ms_twenty,speed_ten, fn ) {
    //1.先清除之前的定时器，以本次移动为准
    clearInterval ( obj.timeID );
    ms_twenty = ms_twenty ? ms_twenty : 20;
    speed_ten = speed_ten ? speed_ten : 10;
    //2.开始本次移动
    obj.timeID = setInterval ( function () {
        ...
        */
        ...
        for ( var key in attrs ) {
            if ( key == "zIndex" || key == "backgroundColor" ) {
                ...
                var step = ( target - current ) / speed_ten;
